...
server <- function(input, output){
  ...
  base_final <- read.csv("C:/Users/jdbul/OneDrive/Escritorio/TRABAJO-1-TAE/accident_final.csv", encoding="UTF-8")
  ...
  catastro <- read_sf("C:/Users/jdbul/OneDrive/Escritorio/TRABAJO-1-TAE/Limite_Barrio_Vereda_Catastral.shp")
